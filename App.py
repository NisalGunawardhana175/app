...
def get_snowflake_connection():
    conn = snowflake.connector.connect(
        user='NisalAPP',  # Replace with your Snowflake username
        password='Nisal$12345678',  # Replace with your Snowflake password
        account='DKB76011',  # Replace with your Snowflake account
        warehouse='COMPUTE_WH',  # Replace with your Snowflake warehouse
        database='APP_DB',  # Replace with your Snowflake database
        schema='APP_SCHEMA'  # Replace with your Snowflake schema
    )
    return conn
...
if not st.session_state.logged_in:
    ...
    def load_data():
        ...
        query = "SELECT * FROM APP_DB.APP_SCHEMA.APP_TABLE"
